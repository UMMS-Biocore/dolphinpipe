...
<script src="//d3js.org/d3.v3.min.js" charset="utf-8"></script>
    <div class="container">
      <div class="row">
		...
		<div class="col-md-1">
			  <button id = "saveButton" type="submit" class="btn btn-default btn-danger" name="button" onclick="save()" style="width: auto; margin-top:15px;" disabled><i class="glyphicon glyphicon-ok"></i></button>
		</div>
		<div class="col-md-2">
...
// I/O id naming:[0]i = input,o = output -[1]process database ID -[2]The number of I/O of the selected process -[3]Parameter database ID- [4]uniqe number
        for (var k = 0; k < inputs.length; k++) {
		    console.log("pId:" + inputs[k].parameter_id)
	...
	function showEdges(){
		d3.selectAll("line[status = 'standard']").attr("opacity",1)
		d3.selectAll("line[status = 'hide']").attr("opacity",0.1)
    ...
    function addCandidates2Dict() {
      ...
      for (var c = 0; c < candList.length; c++) {
        ...
        pozList = [circx,circy,gid]
        candidates[currid] = pozList
      }
    }


    function creadteEdges(first,second) {
	...
	function rename() {
		...
		function save(){
			...
			savedList = [{"name":sName}, {"nodes":saveNodes}, saveMainG, {"edges": edges}]
